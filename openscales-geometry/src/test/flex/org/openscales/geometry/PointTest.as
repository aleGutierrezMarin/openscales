package org.openscales.geometry
{
	...
	{		
		...
		[Test] public function testClonePoint():void {
		...
		[Test] public function testEqualsPoint():void {
			
			var point:Point =  new Point(4,5);
			var point2:Point = point.clone() as Point;
			Assert.assertTrue(point.equals(point2));
		}
		[Test] public function testToShortSTringPoint():void {
		...
		[Test] public function testIntersectsPoint():void {
			
			var point:Point =  new Point(4,5);
			var point2:Point = new Point(4,5);
			point.intersects(point2);
		}
		[Test] public function testDistanceToPoint():void {
			
			//todo:
		}
		
		[Test] public function testBoundsToPoint():void {
			var point:Point =  new Point(4,5);
