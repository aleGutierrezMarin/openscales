package org.openscales.core.layer
{
	...
	{
		private var _instance:KML;
		
		[Embed(source="/assets/kml/KML_Samples.kml",mimeType="application/octet-stream")]
		private const KMLFile:Class;
		
		public function KMLTest()
		{
		}
		
		[Before]
		public function setUp():void{
			_instance = new KML("instance");
		}
		...
		/**
		 * Validates that when you have a KML layer without features
		...
		{
			_instance.setMaxExtent("-150,-20,160,10,EPSG:4326");
			var map:Map = new Map();
			...
			assertEquals("Wrong maxExtent bounds projection", ProjProjection.getProjProjection("EPSG:4326"), _instance.maxExtent.projection)
		}
	}
}