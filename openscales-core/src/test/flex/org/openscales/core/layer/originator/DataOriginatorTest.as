package org.openscales.core.layer.originator
{
	...
	{		
		...
		public function testIsCoveredAreaExtent():void
		{
			...
			var moyResolution:Resolution = new Resolution((minResolution+maxResolution)/2.0);
