package org.openscales.geometry
{
	...
	public class GeometryTest
	{
		...
		[Test] public function testGeometryToVertices():void {
			...
			for(i=0;i <nbVector3d;i++) {
				arraypointlonlat[i] = new Location(null, 18899898, 89894598);
			}
			endTime = new Date();
			...
			for(i=0;i <nbVector3d;i++) {
				arraypoint[i]= new org.openscales.geometry.Point(null, 18899898, 89894598);
			}
			endTime = new Date();
			...
			var lonlat:Location = new Location(Geometry.DEFAULT_SRS_CODE, Number.MAX_VALUE, Number.MAX_VALUE); 
			...
			var poinOpenscales:org.openscales.geometry.Point = new org.openscales.geometry.Point(Geometry.DEFAULT_SRS_CODE, Number.MAX_VALUE, Number.MAX_VALUE); 
