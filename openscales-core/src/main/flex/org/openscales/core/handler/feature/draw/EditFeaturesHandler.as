package org.openscales.core.handler.feature.draw
{
	 ...
	 */
	public class EditFeaturesHandler extends ClickHandler
	{
		/**
		 ...
		 */
		public function EditFeaturesHandler(map:Map=null, active:Boolean=false, enableClickSelection:Boolean=true, enableBoxSelection:Boolean=true, enableOverSelection:Boolean=false) {
		...
		private function select(featuresToSelect:Vector.<Feature>, additiveMode:Boolean=false):void {
			...
			// Add all the selected features to the selection
		...
		private function setSelectedStyle(feature:Feature):void {
			...
			feature.style = (this.selectedStyle != null) ? this.selectedStyle(feature) : EditFeaturesHandler.defaultSelectedStyle(feature);
		}
