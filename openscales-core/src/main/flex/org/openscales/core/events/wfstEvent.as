package org.openscales.core.events
{
	 ...
	 **/
	public class wfstEvent extends FeatureEvent
	{
		...
		public function wfstEvent(type:String,feature:Feature,ctrlStatus:Boolean = false,bubbles:Boolean=false,cancelable:Boolean=false,bounds:Bounds = null)
		{
