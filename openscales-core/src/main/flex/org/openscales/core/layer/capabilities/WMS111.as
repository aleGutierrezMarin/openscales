	...
	public class WMS111 extends CapabilitiesParser
	{
		...
		public override function read(doc:XML):HashMap {
			...
			for each (var layer:XML in layerNodes){
				...
				layerCapabilities.put("LatLonBoundingBox", new Bounds(csSrsList,left,bottom,right,top));
				...
				layerCapabilities.put("BoundingBox", new Bounds(csSrsList,left,bottom,right,top));
